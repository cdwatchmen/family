...
public class Sampler
{
	...
	// 接口帐号
	private static final String account = "1001@501088530001";
	
	// 接口密钥
	private static final String authkey = "9288B7E4B1ABB8FEF862F047D75B7BB9";
	...
	public static void main(String[] args) throws Exception
	{
		...
		*/
		...
		List<SendResultBean> listItem = sendOnce("13880529348", "Java接口测试内容");
		if(listItem != null)
		{
