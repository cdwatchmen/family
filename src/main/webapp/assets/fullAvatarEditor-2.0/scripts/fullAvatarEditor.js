function fullAvatarEditor() {
	...
	var file			= 'assets/fullAvatarEditor-2.0/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= 'assets/fullAvatarEditor-2.0/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 200;							//flash文件的宽度
	var	height			= 200;							//flash文件的高度
