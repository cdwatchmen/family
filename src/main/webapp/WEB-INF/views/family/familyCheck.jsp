					...
					<ul class="nav nav-list">
						<li >
							<a href="${ctx}/user/userSpace">
								...
								<span class="" style="margin:0">个人信息</span>
							</a>
						</li>
					...
					<div class="page-content">
						...
						<div class="row">  
							 <div class="col-xs-6 col-sm-10"> 
								<table class="easyui-datagrid" style="margin-left:5px; margin-right:5px; width:98%" id="admin_apply_grid"> 
								</table>    
							 </div>
					    </div> 
...
<![endif]-->
		...
		$('#admin_apply_grid').datagrid({
			...
			toolbar:[{
				...
				handler:function(){
					var applies = $('#admin_apply_grid').datagrid('getSelections');
					$.ajax({
